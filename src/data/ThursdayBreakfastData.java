...
public class ThursdayBreakfastData {

	public static ArrayList<Food> petList = new ArrayList();

	private static final String fileName = "thursdayBreakfast.json";
	private static JsonUtils<Food> jsonUtils = new JsonUtils<>(fileName);

	public static List<Food> getThursdayBreakfastList() {
	...
	public static boolean saveThursdayBreakfast(Food food) {
	...
	public static boolean deleteThursdayBreakfast(int i, Food food) {
	...
	public static boolean editThursdayBreakfast(int i, Food food) {
