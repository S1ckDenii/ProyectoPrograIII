...
public class MondayLunchData {

	public static ArrayList<Food> petList = new ArrayList();

	private static final String fileName = "mondayLunch.json";
	private static JsonUtils<Food> jsonUtils = new JsonUtils<>(fileName);

	public static List<Food> getMondayLunchList() {
	...
	public static boolean saveMondayLunch(Food food) {
	...
	public static boolean deleteMondayLunch(int i, Food food) {
	...
	public static boolean editMondayLunch(int i, Food food) {
