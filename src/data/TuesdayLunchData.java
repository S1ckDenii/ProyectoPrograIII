...
public class TuesdayLunchData {

	public static ArrayList<Food> petList = new ArrayList();

	private static final String fileName = "tuesdayLunch.json";
	private static JsonUtils<Food> jsonUtils = new JsonUtils<>(fileName);

	public static List<Food> getTuesdayLunchList() {
	...
	public static boolean saveTuesdayLunch(Food food) {
	...
	public static boolean deleteTuesdayLunch(int i, Food food) {
	...
	public static boolean editTuesdayLunch(int i, Food food) {
